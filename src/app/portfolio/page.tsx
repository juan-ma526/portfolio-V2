  ...
  return (
    <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: 0 }} transition={{ duration: 1 }}>
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <div className="relative w-[23rem] h-[16rem] md:w-[28rem] md:h-[20rem] lg:w-[500px] lg:h-[350px] xl:w-[600px] xl:h-[420px]">
                    <div className="w-[17rem] h-[14rem] md:w-[21rem] md:h-[18rem] xl:w-[28rem] xl:h-[23rem] relative">
                      <Image src={item.img} fill alt="Imagen projecto" />
                    </div>
                    <div className="absolute right-0 top-0 w-16 h-52 md:h-[18rem] xl:h-[23rem] bg-slate-200"></div>
                  </div>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        <h1 className="text-8xl">Tienes algun Projecto?</h1>
